...
const bellSound = new Audio('../media/audio/bell.wav');
const startSound = new Audio('../media/audio/game start.wav');
const winSound = new Audio('../media/audio/win.wav');
const loseSound = new Audio('../media/audio/lose.wav');
...
function flipCardBack() {
    ...
    comCard.src = '../media/img/back.png';
    userCard.src = '../media/img/back.png';
}
...
function flipCardFront(comIndex, userIndex) {
    ...
    comCard.src = '../media/img/' + comIndex +'.png';
    userCard.src = '../media/img/' + userIndex + '.png';
